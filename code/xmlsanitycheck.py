#!/usr/bin/python
# Goal: read from stdin and write to stdout
# This program will simply check that the input is really parsable by Python SAX
...
if __name__ == "__main__":
    ...
    filter_handler = text_normalize_filter(parser, downstream_handler, sub, manualOverride = True)
