...
#
# $Id: __init__.py,v 1.30 2004/08/14 04:30:12 stevenbird Exp $
...
three sub-modules for specialized kinds of parsing:
  ...
  - C{lib.nltk.parser.chart} defines chart parsing, which uses dynamic
    programming to efficiently parse texts.
  - C{lib.nltk.parser.chunk} defines chunk parsing, which identifies
    non-overlapping linguistic groups in a text.
  - C{lib.nltk.parser.probabilistic} defines probabilistic parsing, which
...
from lib.nltk.tree import Tree, ImmutableTree
from lib.nltk.token import Token
from lib.nltk.cfg import Nonterminal, CFG, CFGProduction, nonterminals
...
def demo():
    """
    A demonstration of the parsers defined by lib.nltk.parser.  The user
